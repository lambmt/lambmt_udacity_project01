...
class CloudStorageApplicationTests {
    ...
    private HomeTestObject homeTestObject;
    private LoginTestObject loginTestObject;
    private SignupTestObject signupTestObject;
    ...
    public void testSignupAndLogin() {
        String firstName = "lambmt", lastName = "fsoft", username = "lambmtfsoft", password = "0910";

        WebDriverWait wait = new WebDriverWait(driver, 10);
        signupTestObject = new SignupTestObject(driver);
        loginTestObject = new LoginTestObject(driver);
        homeTestObject = new HomeTestObject(driver);

        driver.get("http://localhost:" + this.port + "/signup");
        signupTestObject.signup(firstName, lastName, username, password);
        driver.get("http://localhost:" + this.port + "/login");
        wait.until(webDriver -> webDriver.findElement(By.name("username")));
        loginTestObject.login(username, password);
        homeTestObject.logout();
        wait.until(webDriver -> webDriver.findElement(By.name("username")));
        driver.get("http://localhost:" + this.port + "/home");
        Assertions.assertNotEquals("Home", driver.getTitle());
    }
    ...
    @Test
    public void testTabNote() {
        String firstName = "lambmt", lastName = "fsoft", username = "lambmtfsoft", password = "0910";
        String noteTitle = "note title", noteDescription = "note description";
        WebDriverWait wait = new WebDriverWait(driver, 10);
        signupTestObject = new SignupTestObject(driver);
        loginTestObject = new LoginTestObject(driver);
        homeTestObject = new HomeTestObject(driver);
        ...
        homeTestObject.createNote(noteTitle, noteDescription);
        driver.get("http://localhost:" + this.port + "/home");
        wait.until(ExpectedConditions.elementToBeClickable(By.id("nav-notes-tab")));
        driver.findElement(By.id("nav-notes-tab")).click();
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.id("note-title")));
        homeTestObject.editNote(noteTitle, noteDescription);
        driver.get("http://localhost:" + this.port + "/home");
        wait.until(ExpectedConditions.elementToBeClickable(By.id("nav-notes-tab")));
        driver.findElement(By.id("nav-notes-tab")).click();
        wait.until(ExpectedConditions.elementToBeClickable(By.id("note-row-title")));
        result = driver.findElement(By.id("note-row-title")).getText();
        Assertions.assertEquals(result, noteTitle + "edit");
    ...
    @Test
    public void testTabCredential() {
        String firstName = "lambmt", lastName = "fsoft", username = "lambmtfsoft", password = "0910";
        String credUrl = "fpt.com", credUsername = "lambmt", credPassword = "0910";
        WebDriverWait wait = new WebDriverWait(driver, 10);
        signupTestObject = new SignupTestObject(driver);
        loginTestObject = new LoginTestObject(driver);
        homeTestObject = new HomeTestObject(driver);
        ...
        homeTestObject.createCredential(credUrl, credUsername, credPassword);
        ...
        resultList.get(0).click();
        wait.until(ExpectedConditions.elementToBeClickable(By.id("credential-url")));
        homeTestObject.editCredential(credUrl, username, password);
        ...
        Assertions.assertEquals(resultList.get(0).getText(), credUrl + ".vn");
